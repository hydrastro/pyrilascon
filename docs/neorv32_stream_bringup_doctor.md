...
make -C boards/tangnano9k/neorv32_stream_axis_mmio doctor NEORV32_HOME=/actual/path/to/neorv32 SERIAL=/dev/ttyUSB0
```
...
`make -C boards/tangnano9k/neorv32_stream_axis_mmio uart-report LOG=uart.log` expects a completed benchmark log
