`ifndef ASCON_ACCEL_AXIS128_AEAD128_4RPC_TOP_V
`define ASCON_ACCEL_AXIS128_AEAD128_4RPC_TOP_V
...
//   * four Ascon rounds per cycle backend, so p8=2 cycles and p12=3 cycles;
...
// -----------------------------------------------------------------------------
module ascon_accel_axis128_aead128_4rpc_top (
  input  wire         clk_i,
  input  wire         rstn_i,
  ...
  ascon_aead128_mmio_backend_4rpc backend_i (
    .clk_i(clk_i),
    .rstn_i(rstn_i),
