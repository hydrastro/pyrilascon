`ifndef ASCON_AEAD128_MMIO_BACKEND_V
`define ASCON_AEAD128_MMIO_BACKEND_V

`include "ascon_accel_regs.vh"

// -----------------------------------------------------------------------------
// Small register-buffered Ascon-AEAD128 backend for the frozen accelerator ABI.
//
...
// -----------------------------------------------------------------------------
module ascon_aead128_mmio_backend #(
