`ifndef ASCON_AEAD128_MMIO_BACKEND_8RPC_V
`define ASCON_AEAD128_MMIO_BACKEND_8RPC_V

`include "ascon_accel_regs.vh"

// -----------------------------------------------------------------------------
// Eight-rounds-per-cycle register-buffered Ascon-AEAD128 backend for the frozen accelerator ABI.
//
// This is the first real cryptographic backend behind the MMIO register block.
// It is deliberately conservative:
//   * NIST Ascon-AEAD128 only;
//   * eight Ascon rounds per cycle, with p12 split as 8+4 rounds;
...
// -----------------------------------------------------------------------------
module ascon_aead128_mmio_backend_8rpc #(
  ...
  assign round_count_w = (rc_index_q == 4'd12) ? 4'd4 : 4'd8;
  ...
  ascon_round8_comb round8_i(
    .state_i(s_q),
    .rc_start_i(rc_index_q),
    .round_count_i(round_count_w),
