...
1.1 & \today & Added the autonomous descriptor-driven DMA-fed AXI-stream front-end --- RTL engine and system wrapper, Icarus cosimulation ($14$ vectors up to the $1024$-byte/$64$-beat maximum), and a descriptor-oriented firmware driver; moved it from future work to implemented (§\ref{sec:dma}).\\
\bottomrule
\end{tabular}
\end{center}
