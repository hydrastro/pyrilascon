...
def ascon_p6(state: AsconState) -> AsconState:
    return ascon_permutation(state, 6)


def emit_verilog_p6_function() -> str:
    return "\n".join(
        (
...
def emit_verilog_p6_include() -> str:
    return "\n\n".join(("// Generated Ascon-p[6] function.", emit_verilog_p6_function()))


def emit_verilog_p6_module() -> str:
    return "\n".join(
        (
